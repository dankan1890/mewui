...
dependency {
	{ MAME_DIR .. "src/mame/drivers/ymmu100.c",    GEN_DIR .. "mewui/drivers/ymmu100.inc" },
}
custombuildtask {
	{ MAME_DIR .. "src/mame/drivers/ymmu100.ppm", GEN_DIR .. "mewui/drivers/ymmu100.inc",  {  MAME_DIR .. "scripts/build/file2str.py" }, {"@echo Converting src/drivers/ymmu100.ppm...", PYTHON .. " $(1) $(<) $(@) ymmu100_bkg UINT8" }},
}
